...
from apps.subscriptions.views import (
    ActivateSubscriptionAPIView, CancelSubscriptionAPIView, CreateSubscriptionAPIView, DeactivateSubscriptionAPIView, SubscriptionAPIView, SubscriptionDetailAPIView,
...
urlpatterns = [
    ...
    path("deactivate/<int:pk>/", DeactivateSubscriptionAPIView.as_view(), name="deactivate"),
    ...
    path("packages/<int:pk>/", PackagesDetailsAPIView.as_view(), name="package-details"),
]
