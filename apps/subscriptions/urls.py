...
urlpatterns = [
    ...
    path(
        "cancel-subscription/<int:subscription_id>/",
        cancel_subscription,
        name="cancel-subscription",
    ),
    path(
        "activate-subscription/<int:subscription_id>/",
        activate_subscription,
        name="activate-subscription",
    ),
    path(
        "deactivate-subscription/<int:subscription_id>/",
        deactivate_subscription,
    ...
    path(
        "customer-pricing/<int:customer_id>/",
        customer_pricing_packages,
