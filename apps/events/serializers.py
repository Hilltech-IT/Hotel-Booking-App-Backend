...
from apps.property.serializers import OwnerSerializer
...
class EventTicketSerializer(serializers.ModelSerializer):
    ...
    def get_ticket_counts(self, obj):
        ...
        for comp in components:
            ...
            ticket_count = (
                ticket_data.get(ticket_type, {}).get("count", 0)
...
class EventSerializer(serializers.ModelSerializer):
    ...
    allowed_payment_methods = AllowedEventPaymentMethodsSerializer(
