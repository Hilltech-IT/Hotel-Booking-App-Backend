...
from apps.property.views import (
    ...
    PropertyRoomCreateAPIView,
    PropertyRoomImageDeleteAPIView,
    PropertyRoomImageUploadAPIView,
    PropertyRoomImageViewSet,
    PropertyRoomUpdateAPIView,
    PropertyRoomViewSet,
...
urlpatterns = [
    ...
    path(
        "property-images/upload/<int:pk>/",
        PropertyImageUploadAPIView.as_view(),
        name="upload-property-images",
    ),
    path(
        "property-images/<int:pk>/delete/",
        PropertyImageDeleteAPIView.as_view(),
        name="delete-property-images",
    ),
    path(
        "room-images/upload/<int:pk>/",
        PropertyRoomImageUploadAPIView.as_view(),
        name="upload-room-images",
    ),
    path(
        "property-room-images/<int:pk>/delete/",
        PropertyRoomImageDeleteAPIView.as_view(),
        name="delete-room-image",
    ),
    path("rooms/create/", PropertyRoomCreateAPIView.as_view(), name="create-room"),
    path(
        "rooms/update/<int:pk>/",
        PropertyRoomUpdateAPIView.as_view(),
        name="create-room",
    ),
]
