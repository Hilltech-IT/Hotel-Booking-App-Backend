...
from apps.property.hotels.views import ApproveHotelAPIView, CreateHotelRoomView, HotelAPIView, HotelCreateAPIView, HotelDetailAPIView, HotelRoomListView,HotelUpdateAPIView, UpdateHotelRoomView
