...
from apps.bookings.airbnbs.views import (
...
from apps.bookings.event_spaces.views import (
...
from apps.bookings.hotels.views import (
    BookARoomAPIView,
...
router.register(
    r"eventspace-bookings",
    EventSpaceBookingsModelViewSet,
    basename="eventspace-bookings",
)
...
urlpatterns = [
    ...
    path(
        "update-room-booking/<int:pk>/",
        UpdateRoomBookingAPIView.as_view(),
        name="update-room-booking",
    ),
    path(
        "delete-room-booking/<int:pk>/",
        DeleteRoomBookingAPIView.as_view(),
        name="delete-room-booking",
    ),
    path("airbnb-book/", BookAnAirBnBAPIView.as_view(), name="book-airbnb-new"),
    path(
        "airbnb-book/<int:pk>/",
        UpdateAirbnbBookingAPIView.as_view(),
        name="update-aribnb-book-new",
    ),
    path(
        "event-space-book/",
        BookAnEventSpaceAPIView.as_view(),
        name="book-event-space-new",
    ),
    path(
        "event-space-book/<int:pk>/",
        UpdateEventSpaceBookingAPIView.as_view(),
        name="book-event-space-update-delete",
    ),
    path(
        "airbnb-booking-detail/<int:pk>/",
        AirBnBBookingDetailAPIView.as_view(),
        name="bnb-booking-details",
    ),
    path(
        "espace-booking-detail/<int:pk>/",
        EventSpaceBookingDetailAPIView.as_view(),
        name="espace-booking-details",
    ),
    path(
    ...
    path(
        "book-an-event-space/",
        BookEventSpaceAPIView.as_view(),
        name="book-an-event-space",
    ),
]
